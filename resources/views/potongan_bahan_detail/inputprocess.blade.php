    ...
    <div class="form m-auto" style="max-width: 350px;">
        <form action="" method="post">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control" id="kode_potonganbahan_detail" name="kode_potonganbahan_detail" placeholder="Masukan Kode Potongan Bahan Detail" required>
            </div>
